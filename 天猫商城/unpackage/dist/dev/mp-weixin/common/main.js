...
var loading = function loading() {__webpack_require__.e(/*! require.ensure | pages/common/loading */ "pages/common/loading").then((function () {return resolve(__webpack_require__(/*! ./pages/common/loading.vue */ 83));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.config.productionTip = false;_vue.default.prototype.$Request = _api.default;_vue.default.prototype.$Urls = _request.default; // 动画样式
_vue.default.component('loader-on', loading); // bus传值
// 全局使用
_vue.default.prototype.$bus = _bus.default; // 登录弹窗
var model = function model() {Promise.all(/*! require.ensure | pages/common/model */[__webpack_require__.e("common/vendor"), __webpack_require__.e("pages/common/model")]).then((function () {return resolve(__webpack_require__(/*! ./pages/common/model.vue */ 90));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.component('model', model); // 消息提示

...
var _details = _interopRequireDefault(__webpack_require__(/*! ./pages/details/details.vue */ 15));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _details_vue_vue_type_template_id_39cbb4e8_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./details.vue?vue&type=template&id=39cbb4e8&scoped=true& */ 16);
/* harmony import */ var _details_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./details.vue?vue&type=script&lang=js& */ 18);
...
/* harmony import */ var _details_vue_vue_type_style_index_0_id_39cbb4e8_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./details.vue?vue&type=style&index=0&id=39cbb4e8&scoped=true&lang=css& */ 21);
...
var _logic = _interopRequireDefault(__webpack_require__(/*! ../commonJs/logic.js */ 20));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var top = function top() {__webpack_require__.e(/*! require.ensure | pages/details/children/Top */ "pages/details/children/Top").then((function () {return resolve(__webpack_require__(/*! ./children/Top.vue */ 64));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var price = function price() {Promise.all(/*! require.ensure | pages/details/children/Price */[__webpack_require__.e("common/vendor"), __webpack_require__.e("pages/details/children/Price")]).then((function () {return resolve(__webpack_require__(/*! ./children/Price.vue */ 118));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var parame = function parame() {__webpack_require__.e(/*! require.ensure | pages/details/children/Parame */ "pages/details/children/Parame").then((function () {return resolve(__webpack_require__(/*! ./children/Parame.vue */ 126));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var evaluate = function evaluate() {__webpack_require__.e(/*! require.ensure | pages/details/children/Evaluate */ "pages/details/children/Evaluate").then((function () {return resolve(__webpack_require__(/*! ./children/Evaluate.vue */ 139));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var product = function product() {__webpack_require__.e(/*! require.ensure | pages/details/children/Product */ "pages/details/children/Product").then((function () {return resolve(__webpack_require__(/*! ./children/Product.vue */ 147));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default =
...
{
  components: { top: top, price: price, parame: parame, evaluate: evaluate, product: product },
  data: function data() {
    return {
      // 获取胶囊按钮的数据
      tophight: {},
  ...
  methods: {
    ...
    // 请求数据
    getRquest: function getRquest(id) {var _this2 = this;
      // 轮播信息、价格参数信息
      var detail = new this.$Request(this.$Urls.m().detailsurl + '?id=' + id).modeget().
      then(function (res) {

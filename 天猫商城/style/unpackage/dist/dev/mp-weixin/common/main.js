...
var loading = function loading() {__webpack_require__.e(/*! require.ensure | pages/common/loading */ "pages/common/loading").then((function () {return resolve(__webpack_require__(/*! ./pages/common/loading.vue */ 143));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.config.productionTip = false;_vue.default.prototype.$Request = _api.default;_vue.default.prototype.$Urls = _request.default; // 动画样式
_vue.default.component('loader-on', loading); // bus传值
// 全局使用
_vue.default.prototype.$bus = _bus.default; // 登录弹窗
var model = function model() {Promise.all(/*! require.ensure | pages/common/model */[__webpack_require__.e("common/vendor"), __webpack_require__.e("pages/common/model")]).then((function () {return resolve(__webpack_require__(/*! ./pages/common/model.vue */ 150));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.component('model', model); // 消息提示
_vue.default.prototype.$Toast = _toast.default; // 登录按钮
var loginpage = function loginpage() {Promise.all(/*! require.ensure | pages/common/login */[__webpack_require__.e("common/vendor"), __webpack_require__.e("pages/common/login")]).then((function () {return resolve(__webpack_require__(/*! ./pages/common/login.vue */ 157));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.component('loginpage', loginpage);_App.default.mpType = 'app'; // 全局样式
var ordering = function ordering() {__webpack_require__.e(/*! require.ensure | pages/common/ordering */ "pages/common/ordering").then((function () {return resolve(__webpack_require__(/*! ./pages/common/ordering.vue */ 164));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.component('ordering', ordering); // 页面加载full-loading
var fullloading = function fullloading() {__webpack_require__.e(/*! require.ensure | pages/common/full-loading */ "pages/common/full-loading").then((function () {return resolve(__webpack_require__(/*! ./pages/common/full-loading.vue */ 169));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.component('fullloading', fullloading);var app = new _vue.default(_objectSpread({}, _App.default));
